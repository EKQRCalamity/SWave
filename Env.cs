...
namespace SyncWave
{
    internal class Env
    {
        ...
        internal static List<string> SupportedChamps = new List<string>() { "Orianna", "Twitch", "KogMaw", "TahmKench", "Kalista", "Irelia", "Graves", "Nidalee", "LeeSin", "Blitzcrank", "Gangplank", "Brand", "Cassiopeia", "Vayne" };
