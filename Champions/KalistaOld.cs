...
namespace SyncWave.Champions
{
    ...
    internal class KalistaQDamageCalc : DamageCalculation
    {
        ...
        internal override float CalculateDamage(GameObjectBase target)
        {
            ...
            {
                dmg = KalistaOld.QDamage[Env.QLevel] + (KalistaOld.QScaling * Env.Me().UnitStats.TotalAttackDamage);
            }
    ...
    internal class KalistaEDamageCalc : DamageCalculation
    {
        ...
        internal float GetDamageFromStacks(GameObjectBase target, float stacks)
        {
            ...
            if (stacks > 0)
            {
                float baseDamage = Champions.KalistaOld.EDamage[Env.ELevel] + (Champions.KalistaOld.EScaling * Env.Me().UnitStats.TotalAttackDamage);
                damage = baseDamage + ((Champions.KalistaOld.EAddSpearDamage[Env.ELevel] + (Champions.KalistaOld.EAddSpearScaling[Env.ELevel] * Env.Me().UnitStats.TotalAttackDamage)) * (stacks - 1));
    ...
    internal class KalistaOld : SyncWave.Base.Module
    {
        ...
        internal override void Init()
        {
            ...
            Q.SetPrediction(Prediction.MenuSelected.PredictionType.Line, Champions.KalistaOld.QRange - 40, Champions.KalistaOld.QWidth, Champions.KalistaOld.QCastTime, Champions.KalistaOld.QSpeed, true);
        ...
        {
            return Prediction.MenuSelected.GetPrediction(Prediction.MenuSelected.PredictionType.Line, target, Champions.KalistaOld.QRange - 40, Champions.KalistaOld.QWidth, Champions.KalistaOld.QCastTime, Champions.KalistaOld.QSpeed, true);
        }
